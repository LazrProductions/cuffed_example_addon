package com.lazrproductions.cuffed_example_addon.restraints.client.model;
...
public class DiamondHandcuffsArmsModel<T extends LivingEntity> extends HumanoidModel<T> {
	private final ModelPart _root;

	public DiamondHandcuffsArmsModel(ModelPart root) {
		super(root);
		_root = root;
	}
