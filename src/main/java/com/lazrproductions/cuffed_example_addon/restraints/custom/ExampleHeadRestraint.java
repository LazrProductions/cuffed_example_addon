...
/*
    ...
    This is the Restraint class for the Diamond Handcuffs when they're applied to the head.

    Restraint classes may be big and intimidating, but they... well they are.

    First off, head restraints must extend the AbstractHeadRestraint class, which itself extends the AbstractRestraint class.
    ...
    1. CONSTRUCTORS
        First in the class are the constructors, there are two different constructors that MUST be implemented in every restraint class:
            ...
            public MyHeadRestraint()
            public MyHeadRestraint(ItemStack stack, ServerPlayer player, ServerPlayer captor)
    ...
    6. IMPLEMENTABLE INTERFACES
        ...
        -> IBreakableRestraint
            To make your restraint breakable, your restraint needs to implement IBreakableRestraint which has the following functions:
                ...
                public void incrementDurability(ServerPlayer player, int value) // Increment the durablity of this restraint.
            ...
            Please examine the DiamondHandcuffsArmsRestraint class's "Breakable Restraint Management" to see how breakable restraints are implemented,
            also see onTickClient() in that class to see how the break cooldown is ticked down.
...
public class ExampleHeadRestraint extends AbstractHeadRestraint {
    ...
    public ExampleHeadRestraint(ItemStack stack, ServerPlayer player, ServerPlayer captor) {
    ...
    public String getActionBarLabel() {
        return "info.cuffed_example_addon.restraints.example_head_restraint.action_bar";
    }
    public String getName() {
        return "info.cuffed_example_addon.restraints.example_head_restraint.name";
    }
    ...
    public RestraintModelInterface getModelInterface() {
        return new ExampleHeadRestraintModelInterface();
    }
    ...
    public static class ExampleHeadRestraintModelInterface extends RestraintModelInterface {
        ...
        public Class<? extends HumanoidModel<? extends LivingEntity>> getRenderedModel() {
            return null; // leaving these null will render no model when this restraint is equipped
        }
        @Override
